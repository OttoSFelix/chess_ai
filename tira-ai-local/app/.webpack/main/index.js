...
const truncate = __webpack_require__(/*! ./functions/truncate */ "./node_modules/semver/functions/truncate.js")
...
electron_store__WEBPACK_IMPORTED_MODULE_3___default().initRenderer();
var backgroundProcess = undefined;
electron__WEBPACK_IMPORTED_MODULE_0__.app.on("ready", function () {
    ...
    var file = path__WEBPACK_IMPORTED_MODULE_2___default().join(__dirname, "./background-service.pex");
    console.log("Spawning process");
    backgroundProcess = (0,child_process__WEBPACK_IMPORTED_MODULE_1__.spawn)("python3", [file]);
    ...
    backgroundProcess.on("exit", function (message) {
